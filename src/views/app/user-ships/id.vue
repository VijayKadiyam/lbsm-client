<template>
  <div class="main-content">
    <breadcumb :page="'Update User Ship'" :folder="'User Ships'" />
...
export default {
  ...
  methods: {
    ...
    async getData() {
      this.isLoading = true;
      let form = await axios.get(`user_ships/${this.$route.params.id}`);
    ...
    async submit() {
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await axios.patch(`user_ships/${this.$route.params.id}`, this.form);
